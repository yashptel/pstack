...
- `model`: your configured how-explorer model (default `gpt-5.4-mini`)
- `readonly`: `true`
...
- subagent: the default subagent
- `model`: your configured how-explainer model (default `gpt-5.5`)
- `readonly`: `true`
...
After the explanation is complete, spawn one architectural critic per model in your configured how-critics list (defaults `gpt-5.5`, `gpt-5.4-mini`, `gpt-5.4`), all in a single message.
