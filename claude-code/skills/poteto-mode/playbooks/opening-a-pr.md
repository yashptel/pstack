...
A subagent that opens a PR runs `interrogate`, a slop pass, and `/pstack:no-comments`. It returns the URL and does not babysit. Return to the parent.
