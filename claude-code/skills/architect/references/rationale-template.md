...
*Filled in by [arena](../../pstack:arena/SKILL.md). Records which candidate became the base and why, what was adapted from each of the others, and what was rejected and why.*
