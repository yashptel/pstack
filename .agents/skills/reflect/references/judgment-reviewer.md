...
- File-reading calls against any `SKILL.md` file (workspace `.agents/skills/` or another installed skill path)
- subagent prompts that name a skill path
- Tool calls that match a skill's documented commands, including shell and MCP calls
