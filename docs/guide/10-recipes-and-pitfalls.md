...
That's the whole prompt. [`/bro`](../../claude-code/skills/bro/SKILL.md) restates the last message like one human talking to another, no jargon, shorter. Use it when a reply is technically thorough and you still don't know what it said.
...
- **Writing a `SKILL.md` freehand.** Route it through the [Authoring or modifying a skill playbook](../../claude-code/skills/poteto-mode/playbooks/authoring-a-skill.md) so validation and review happen.
