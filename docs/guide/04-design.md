...
The panel comes from your [`/setup-pstack`](../../claude-code/skills/setup-pstack/SKILL.md) configuration, and you can adjust it per task. Ask for more candidates when the decision matters, fewer when it doesn't:
